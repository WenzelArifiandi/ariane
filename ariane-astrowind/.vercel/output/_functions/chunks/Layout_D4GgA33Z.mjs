import { c as createComponent, b as addAttribute, a as renderTemplate, z as defineScriptVars, d as createAstro, r as renderComponent, F as Fragment, u as unescapeHTML, s as spreadAttributes, B as renderScript, C as renderHead, e as renderSlot } from './astro/server_Dd1ybPcg.mjs';
import 'kleur/colors';
/* empty css                                 */
import { c as getAsset, U as UI, d as getCanonical, I as I18N, S as SITE, M as METADATA } from './permalinks_BqIyvsQ-.mjs';
import 'clsx';
import { c as createSvgComponent } from './runtime_BZ0yMSN_.mjs';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { b as getImage } from './_astro_assets_CnVLaYZZ.mjs';
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/common/CommonMeta.astro", void 0);
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/assets/favicons/apple-touch-icon.png";
							}
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/Favicons.astro", void 0);
...
const $$CustomStyles = createComponent(($$result, $$props, $$slots) => {
  ...
  :root {
    ...
    /* ——— Site (legacy) design tokens ——— */
    /* Core neutrals and page */
    --ink: #101114;
    --page: #FEFBFF;
    ...
    /* Typography */
    --h1: clamp(2.5rem, 3vw + 1rem, 4rem);
    --h2: clamp(1.5rem, 1.5vw + 1rem, 2rem);
    --body: clamp(1rem, 0.2vw + 0.9rem, 1.125rem);

    /* Radii / shadow */
    --radius: 12px;
    --shadow: 0 8px 24px rgba(0, 0, 0, 0.06);

    /* Minimal layout helpers to match site */
    --pad-x: clamp(1rem, 4vw, 2rem);
    --align-shift: 20px;

    /* M3 tokens (light) */
    --md-sys-color-primary: #7150D9;
    --md-sys-color-on-primary: #fff;
    --md-sys-color-surface: var(--page);
    --md-sys-color-on-surface: var(--ink);
    --md-sys-shape-corner-small: 8px;
    --md-sys-shape-corner-medium: 12px;
    --md-sys-shape-corner-large: 20px;
    --md-sys-elevation-1: 0 6px 20px rgba(0,0,0,.06);
    --md-sys-elevation-2: 0 12px 28px rgba(0,0,0,.08);
    --md-sys-motion-duration-short: 140ms;
    --md-sys-motion-ease-standard: cubic-bezier(.2, 0, 0, 1);
  }
  ...
  .dark {
    ...
    /* M3 tokens (dark) */
    --md-sys-color-primary: color-mix(in oklab, #7150D9, white 10%);
    --md-sys-color-on-primary: #111;
    --md-sys-color-surface: #0f0f12;
    --md-sys-color-on-surface: #e8e8ee;
  }

  /* ——— Global helpers from site to aid migration ——— */
  ...
  .align-hero { padding-left: var(--pad-x); }

  /* Tighten padding/alignment on very small screens */
  @media (max-width: 420px) {
    :root { --pad-x: 8px; --align-shift: 12px; }
    .align-hero { padding-left: calc(var(--pad-x) + var(--align-shift)); }
  }

  .card { border-radius: var(--radius); box-shadow: var(--shadow); }
  .accent { color: var(--wisteria); }

  /* Material 3-inspired button/class parity */
  .btn { display:inline-flex; align-items:center; gap:.5rem; padding:.7rem 1rem; border-radius:999px; border:0; text-decoration:none; -webkit-appearance:none; appearance:none; }
  .btn.m3 { background: var(--md-sys-color-primary); color: var(--md-sys-color-on-primary); box-shadow: var(--md-sys-elevation-1); font-weight:650; }
  .btn.m3::after { content: none; }
  .btn.m3:hover { transform: translateY(-1px); box-shadow: var(--md-sys-elevation-2); }

  a.btn, a.btn:hover, a.btn:visited, a.btn:active { text-decoration: none !important; }

  /* Global Maker chip style so it can be reused (e.g., for CTA) */
  .chip.m3 { background: var(--md-sys-color-primary); color: var(--md-sys-color-on-primary); border: 0; border-radius: 999px; padding: .45rem .8rem; box-shadow: var(--md-sys-elevation-1); cursor: pointer; font-weight: 650; white-space: nowrap; transition: transform var(--md-sys-motion-duration-short) var(--md-sys-motion-ease-standard), box-shadow var(--md-sys-motion-duration-short) var(--md-sys-motion-ease-standard); font-size: var(--body); line-height: 1.2; font-family: inherit; display: inline-flex; align-items: center; gap: .35rem; text-decoration: none; }
  .chip.m3:hover { box-shadow: var(--md-sys-elevation-2); transform: translateY(-1px); }
  .chip.m3 .material-symbols-rounded { color: #fff; font-variation-settings: 'FILL' 1, 'wght' 600, 'GRAD' 0, 'opsz' 24; font-size: 18px; vertical-align: -2px; }
</style>`;
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/CustomStyles.astro", void 0);
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/common/ApplyColorMode.astro", void 0);
...
const $$Astro$4 = createAstro("https://wenzelarifiandi.com");
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./app-store_BVk3AoU_.mjs'),"/src/assets/images/default.png": () => import('./default_FidTMfoN.mjs'),"/src/assets/images/google-play.png": () => import('./google-play_Dbqm7Z2l.mjs'),"/src/assets/images/hero-image.png": () => import('./hero-image_DuAyo8Jm.mjs')});
  } catch (error) {
  }
  return images;
};
...
const $$Astro$3 = createAstro("https://wenzelarifiandi.com");
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/common/Metadata.astro", void 0);
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/common/SiteVerification.astro", void 0);

var __freeze$1 = Object.freeze;
var __defProp$1 = Object.defineProperty;
var __template$1 = (cooked, raw) => __freeze$1(__defProp$1(cooked, "raw", { value: __freeze$1(cooked.slice()) }));
var _a$1;
const $$Astro$2 = createAstro("https://wenzelarifiandi.com");
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);

const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${null}`;
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/common/Analytics.astro", void 0);
...
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/components/common/BasicScripts.astro", void 0);

const $$Astro$1 = createAstro("https://wenzelarifiandi.com");
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$ClientRouter;
  const { fallback = "animate" } = Astro2.props;
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}${addAttribute(textDirection, "dir")} class="2xl:text-[20px]"> <head>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "CustomStyles", $$CustomStyles, {})}${renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}<!-- Material Symbols for rounded icons used by site components --><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@24,500,0,0"><!-- Comment the line below to disable View Transitions -->${renderComponent($$result, "ClientRouter", $$ClientRouter, { "fallback": "swap" })}${renderHead()}</head> <body class="antialiased text-default bg-page tracking-tight"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})} </body></html>`;
}, "/Users/wenzelarifiandi/ariane/ariane/ariane-astrowind/src/layouts/Layout.astro", void 0);
