...
import { g as getOriginFromRequest, a as getRpIdFromOrigin, b as getEnv, v as verify, m as makeCookie, i as isProd, s as sign } from '../../../chunks/signer_BzIjp19d.mjs';
...
const POST = async ({ request }) => {
  ...
  const stored = credId ? store.getById(credId) : void 0;
  ...
  const sessionCookie = makeCookie("session", sign(JSON.stringify(session), secret), {
    httpOnly: true,
    secure: isProd(),
    sameSite: "Strict",
    path: "/",
