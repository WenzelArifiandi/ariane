    ...
    const data = {
      ...
      env: {
        AUTH_MODE:
          ...
          (import.meta as any).env?.AUTH_MODE ||
          "public",
        ...
        PUBLIC_SANITY_API_VERSION: Boolean(
        ...
        ENABLE_EMAIL_NOTIFICATIONS:
          process.env.ENABLE_EMAIL_NOTIFICATIONS ?? null,
        PUBLIC_USE_LOCAL_ICONS:
          (process.env.PUBLIC_USE_LOCAL_ICONS ||
            (import.meta as any).env?.PUBLIC_USE_LOCAL_ICONS) ??
          null,
      },
      request: {
        host,
